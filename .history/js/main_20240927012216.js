// Select the element with the specified href
let link = document.querySelector('a[href="https://elfsight.com/google-reviews-widget/?utm_source=websites&utm_medium=clients&utm_content=google-reviews&utm_term=127.0.0.1&utm_campaign=free-widget"]');

// If the element exists, remove it
if (link) {
    console.log('Link found and removed');
    link.remove();
}
else {
